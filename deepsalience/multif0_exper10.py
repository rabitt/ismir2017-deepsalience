...
def main():
    ...
    y1 = Conv2D(
        256, (5, 5), padding='same', activation='relu', name='bendy1'
    )(inputs)
    y2 = Conv2D(
        16, (70, 3), padding='same', activation='relu', name='harmonics'
    )(y1)
    y3 = Conv2D(
        128, (3, 3), padding='same', activation='relu', name='smoothy1'
    )(y2)
    y4 = Conv2D(
        8, (360, 1), padding='same', activation='relu', name='distribution'
    )(y3)
    y5 = Conv2D(
